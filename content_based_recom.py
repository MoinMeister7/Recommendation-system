...
def start():
    ...
    titel = st.text_input("Filmtitel:", "The Dark Knight")
    ...
    #Trennlinie
        ...
        with tab3:
            ...
            text = """
                <h6>- Filme werden unabhängig von ihrer Bewertung/Popularität bewertet</h6>
                <h6>-  unser Empfehlungsprogramm aufgrund von mehr Metadaten mehr Informationen erfassen konnte und uns (wohl) bessere Empfehlungen gegeben hat</h6>
                <h6>- Experimentieren, indem wir verschiedene Gewichtungen für unsere Merkmale(Schauspieler, Genres etc.) ausprobieren, Anzahl der Schlüsselwörter, die wir verwenden begrenzen, Genres auf Grundlage ihrer Häufigkeit gewichten, nur Filme in der selben Sprachen anzeigen etc.</h6>
                """
